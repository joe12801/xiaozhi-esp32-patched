# XiaoZhi ESP32 Patched

> This repository is based on the OmniX-Space XiaoZhi ESP32 project and includes local playback stability fixes around `esp32_music.cc`.
